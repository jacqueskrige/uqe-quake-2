...
void SV_GameMap_f (void)
{
	...
	// jkrige - don't attempt to save in deathmatch or cinematics
	if (!dedicated->value && !Cvar_VariableValue("deathmatch") && Q_strcasecmp (map+((int)strlen(map))-4, ".cin") && Q_strcasecmp (map+((int)strlen(map))-4, ".pcx"))
	//if (!dedicated->value) // jkrige - don't attempt to save in deathmatch or cinematics
	{
