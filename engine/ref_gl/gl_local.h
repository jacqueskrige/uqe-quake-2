...
// jkrige - scale2d
#define VID_SCALECHAR (8 * vid.scale2d.factor)
#define VID_SCALECHAR16 (16 * viddef.scale2d.factor)
#define VID_SCALEFACTOR vid.scale2d.factor
// jkrige - scale2d
...
extern	cvar_t	*gl_wireframe; // jkrige - wireframe
...
typedef struct
{
	...
	qboolean	ext_nonpow2;

	// jkrige - texture size
	int			max_texturesize;

	// jkrige - anisotropic filtering
	qboolean	ext_anisotropic;
