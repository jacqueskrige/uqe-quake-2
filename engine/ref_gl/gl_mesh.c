...
//		if ( currententity->flags & ( RF_SHELL_RED | RF_SHELL_GREEN | RF_SHELL_BLUE ) )
		...
		else
		{
			...
			for ( i = 0; i < paliashdr->num_xyz; i++ )
			{
				...
				float l;
				l1 = shadedots[verts[i].lightnormalindex];
				l2 = shadedots2[verts[i].lightnormalindex];
				...
				//        - also fixes fullbright
				if ((gl_wireframe->value != 0) | (r_fullbright->value != 0))
					l = 1;
		...
		while (1)
		{
			...
			else
			{
				do
				{
					...
					// jkrige - light lerping - begin
					//l = shadedots[verts[index_xyz].lightnormalindex];
					l1 = shadedots[verts[index_xyz].lightnormalindex];
					l2 = shadedots2[verts[index_xyz].lightnormalindex];
...
// =================
	...
	// jkrige - light lerping - begin
	lightlerpoffset = currententity->angles[1] * (SHADEDOT_QUANT / 360.0);
