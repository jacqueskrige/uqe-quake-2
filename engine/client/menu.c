...
static void M_Banner( char *name )
{
	...
	// jkrige - scale2d
	re.DrawPic( viddef.width / 2 - (w*VID_SCALEFACTOR) / 2, viddef.height / 2 - (110*VID_SCALEFACTOR), name );
...
{
	// jkrige - scale2d
	re.DrawChar ( cx + ((int)(viddef.width - 320*VID_SCALEFACTOR)>>1), cy + ((int)(viddef.height - 240*VID_SCALEFACTOR)>>1), num);
...
void M_DrawTextBox (int x, int y, int width, int lines)
{
	...
	// draw left side
	// jkrige - scale2d
	cx = x*VID_SCALEFACTOR;
	cy = y*VID_SCALEFACTOR;
	//cx = x;
	//cy = y;
	// jkrige - scale2d
	...
	// jkrige - scale2d
	M_DrawCharacter (cx, cy+VID_SCALECHAR, 7);
	...
	while (width > 0)
	{
		...
		// jkrige - scale2d
		M_DrawCharacter (cx, cy+VID_SCALECHAR, 8);
		cx += VID_SCALECHAR;
	...
	// jkrige - scale2d
	M_DrawCharacter (cx, cy+VID_SCALECHAR, 9);
...
void M_Main_Draw (void)
{
	...
	for ( i = 0; names[i] != 0; i++ )
	{
		...
		// jkrige - scale2d
		if ( (w*VID_SCALEFACTOR) > widest )
			widest = w*VID_SCALEFACTOR;
		// jkrige - scale2d
	...
	// jkrige - scale2d
	ystart = ( viddef.height / 2 - (110*VID_SCALEFACTOR) );
	xoffset = ( viddef.width - widest + (70*VID_SCALEFACTOR) ) / 2;
	...
	for ( i = 0; names[i] != 0; i++ )
	{
		...
		{
			// jkrige - scale2d
			re.DrawPic( xoffset, ystart + (i * (40*VID_SCALEFACTOR)) + (13*VID_SCALEFACTOR), names[i] );
	...
	// jkrige - scale2d
	re.DrawPic( xoffset, ystart + (m_main_cursor * (40*VID_SCALEFACTOR)) + (13*VID_SCALEFACTOR), litname );
	M_DrawCursor( xoffset - (25*VID_SCALEFACTOR), ystart + (m_main_cursor * (40*VID_SCALEFACTOR)) + (13*VID_SCALEFACTOR), (int)(cls.realtime / 100)%NUM_CURSOR_FRAMES );
	...
	// jkrige - scale2d
	re.DrawPic( xoffset - (30*VID_SCALEFACTOR) - (w*VID_SCALEFACTOR), ystart, "m_main_plaque" );
	re.DrawPic( xoffset - (30*VID_SCALEFACTOR) - (w*VID_SCALEFACTOR), ystart + (h+5)*VID_SCALEFACTOR, "m_main_logo" );
...
{
	// jkrige - scale2d
	s_multiplayer_menu.x = (viddef.width * 0.50) - (64*VID_SCALEFACTOR);
	...
	// jkrige - scale2d
	s_start_network_server_action.generic.y		= 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_player_setup_action.generic.y		= 20*VID_SCALEFACTOR;
...
static void KeyCursorDrawFunc( menuframework_s *menu )
{
	// jkrige - scale2d
	if ( bind_grab )
		re.DrawChar( menu->x, menu->y + (menu->cursor * 9)*VID_SCALEFACTOR, '=' );
	else
		re.DrawChar( menu->x, menu->y + (menu->cursor * 9)*VID_SCALEFACTOR, 12 + ( ( int ) ( Sys_Milliseconds() / 250 ) & 1 ) );
	//if ( bind_grab )
...
static void DrawKeyBindingFunc( void *self )
{
	...
	{
		// jkrige - scale2d
		Menu_DrawString( a->generic.x + a->generic.parent->x + (16*VID_SCALEFACTOR), a->generic.y + a->generic.parent->y, "???" );
	...
	else
	{
		...
		// jkrige - scale2d
		Menu_DrawString( a->generic.x + a->generic.parent->x + (16*VID_SCALEFACTOR), a->generic.y + a->generic.parent->y, name );
		//Menu_DrawString( a->generic.x + a->generic.parent->x + 16, a->generic.y + a->generic.parent->y, name );
		// jkrige - scale2d

		// jkrige - scale2d
		x = strlen(name) * VID_SCALECHAR;
		//x = strlen(name) * 8;
		// jkrige - scale2d
		...
		{
			// jkrige - scale2d
			Menu_DrawString( a->generic.x + a->generic.parent->x + (24*VID_SCALEFACTOR) + x, a->generic.y + a->generic.parent->y, "or" );
			Menu_DrawString( a->generic.x + a->generic.parent->x + (48*VID_SCALEFACTOR) + x, a->generic.y + a->generic.parent->y, Key_KeynumToString (keys[1]) );
...
static void Keys_MenuInit( void )
{
	...
	s_keys_prev_weapon_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_change_weapon_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_walk_forward_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_backpedal_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_turn_left_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_turn_right_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_run_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_step_left_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_step_right_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_sidestep_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_look_up_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_look_down_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_center_view_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_mouse_look_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_keyboard_look_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_move_up_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_move_down_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_inventory_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_inv_use_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_inv_drop_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_inv_prev_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_inv_next_action.generic.y		= y += 9*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_keys_help_computer_action.generic.y		= y += 9*VID_SCALEFACTOR;
...
// jkrige - lookstrafe menu removal
...
void Options_MenuInit( void )
{
	...
	*/
	...
	s_options_menu.y = viddef.height * 0.50 - (58*VID_SCALEFACTOR);
	...
	s_options_musicvolume_slider.generic.y	= 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_options_cdvolume_box.generic.y		= 20*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_options_quality_list.generic.y		= 30*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_options_compatibility_list.generic.y		= 40*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_options_sensitivity_slider.generic.y		= 60*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_options_alwaysrun_box.generic.y	= 70*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_options_invertmouse_box.generic.y	= 80*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_options_lookspring_box.generic.y	= 90*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_options_lookstrafe_box.generic.y	= 90*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_options_freelook_box.generic.y	= 100*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_options_crosshair_box.generic.y	= 110*VID_SCALEFACTOR;
...
*/
	...
	// jkrige - scale2d
	s_options_joystick_box.generic.y	= 120*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_options_customize_options_action.generic.y		= 140*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_options_defaults_action.generic.y		= 150*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_options_console_action.generic.y		= 160*VID_SCALEFACTOR;
...
void M_Credits_MenuDraw( void )
{
	...
	// jkrige - credits scroll fix
	if ((viddef.height - ((cls.realtime - credits_start_time) / 40.0F) + credits_start_line * (VID_SCALECHAR+(VID_SCALECHAR/4))) < -(VID_SCALECHAR+(VID_SCALECHAR/4)))
	{
		credits_start_line++;
	...
	** draw the credits
	*/
	// jkrige - scale2d & credits scroll fix
	//for ( i = 0, y = viddef.height - ( ( cls.realtime - credits_start_time ) / 40.0F ); credits[i] && y < viddef.height; y += 10, i++ )
	for ( i = credits_start_line, y = viddef.height - ( ( cls.realtime - credits_start_time ) / 40.0F ) + credits_start_line * (VID_SCALECHAR+(VID_SCALECHAR/4)); credits[i] && y < viddef.height+(VID_SCALECHAR+(VID_SCALECHAR/4)); y += (VID_SCALECHAR+(VID_SCALECHAR/4)), i++ )
	// jkrige - scale2d & credits scroll fix
	{
		...
		for ( j = 0; credits[i][j+stringoffset]; j++ )
		{
			...
			// jkrige - scale2d
			x = ( viddef.width - strlen( credits[i] ) * VID_SCALECHAR - stringoffset * VID_SCALECHAR ) / 2 + ( j + stringoffset ) * VID_SCALECHAR;
...
void Game_MenuInit( void )
{
	...
	// jkrige - scale2d
	s_medium_game_action.generic.y		= 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_hard_game_action.generic.y		= 20*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_load_game_action.generic.y		= 40*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_save_game_action.generic.y		= 50*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_credits_action.generic.y		= 60*VID_SCALEFACTOR;
...
void LoadGame_MenuInit( void )
{
	...
	// jkrige - scale2d
	s_loadgame_menu.x = viddef.width * 0.50 - (120*VID_SCALEFACTOR);
	s_loadgame_menu.y = viddef.height * 0.50 - (58*VID_SCALEFACTOR);
	...
	for ( i = 0; i < MAX_SAVEGAMES; i++ )
	{
		...
		// jkrige - scale2d
		s_loadgame_actions[i].generic.y = ( i ) * (10*VID_SCALEFACTOR);
		...
		{
			// jkrige - scale2d
			s_loadgame_actions[i].generic.y += 10*VID_SCALEFACTOR;
...
void SaveGame_MenuInit( void )
{
	...
	// jkrige - scale2d
	s_savegame_menu.x = viddef.width * 0.50 - (120*VID_SCALEFACTOR);
	s_savegame_menu.y = viddef.height * 0.50 - (58*VID_SCALEFACTOR);
	...
	for ( i = 0; i < MAX_SAVEGAMES-1; i++ )
	{
		...
		// jkrige - scale2d
		s_savegame_actions[i].generic.y = ( i ) * (10*VID_SCALEFACTOR);
...
void JoinServer_MenuInit( void )
{
	...
	// jkrige - scale2d
	s_joinserver_menu.x = (viddef.width * 0.50) - (120*VID_SCALEFACTOR);
	...
	// jkrige - scale2d
	s_joinserver_search_action.generic.y	= 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_joinserver_server_title.generic.x    = 80*VID_SCALEFACTOR;
	s_joinserver_server_title.generic.y	   = 30*VID_SCALEFACTOR;
	...
	for ( i = 0; i < MAX_LOCAL_SERVERS; i++ )
	{
		...
		// jkrige - scale2d
		s_joinserver_server_actions[i].generic.y		= (40*VID_SCALEFACTOR) + ((i*10)*VID_SCALEFACTOR);
...
//=======
	...
	*/
	...
	// jkrige - scale2d
	s_rules_box.generic.y	= 20*VID_SCALEFACTOR;
...
//PGM
	...
	// jkrige - scale2d
	s_timelimit_field.generic.y	= 36*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_fraglimit_field.generic.y	= 54*VID_SCALEFACTOR;
	...
	*/
	...
	// jkrige - scale2d
	s_maxclients_field.generic.y	= 72*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_hostname_field.generic.y	= 90*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_startserver_dmoptions_action.generic.x	= 24*VID_SCALEFACTOR;
	s_startserver_dmoptions_action.generic.y	= 108*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_startserver_start_action.generic.x	= 24*VID_SCALEFACTOR;
	s_startserver_start_action.generic.y	= 128*VID_SCALEFACTOR;
...
void DMOptions_MenuInit( void )
{
	...
	// jkrige - scale2d
	s_weapons_stay_box.generic.y	= y += 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_instant_powerups_box.generic.y	= y += 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_powerups_box.generic.y	= y += 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_health_box.generic.y	= y += 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_armor_box.generic.y	= y += 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_spawn_farthest_box.generic.y	= y += 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_samelevel_box.generic.y	= y += 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_force_respawn_box.generic.y	= y += 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_teamplay_box.generic.y	= y += 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_allow_exit_box.generic.y	= y += 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_infinite_ammo_box.generic.y	= y += 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_fixed_fov_box.generic.y	= y += 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_quad_drop_box.generic.y	= y += 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_friendlyfire_box.generic.y	= y += 10*VID_SCALEFACTOR;
...
//ROGUE
	if(Developer_searchpath(2) == 2)
	{
		...
		// jkrige - scale2d
		s_no_mines_box.generic.y	= y += 10*VID_SCALEFACTOR;
		...
		// jkrige - scale2d
		s_no_nukes_box.generic.y	= y += 10*VID_SCALEFACTOR;
		...
		// jkrige - scale2d
		s_stack_double_box.generic.y	= y += 10*VID_SCALEFACTOR;
		...
		// jkrige - scale2d
		s_no_spheres_box.generic.y	= y += 10*VID_SCALEFACTOR;
...
void DownloadOptions_MenuInit( void )
{
	...
	// jkrige - scale2d
	s_download_title.generic.x    = 48*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_allow_download_box.generic.y	= y += 20*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_allow_download_maps_box.generic.y	= y += 20*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_allow_download_players_box.generic.y	= y += 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_allow_download_models_box.generic.y	= y += 10*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_allow_download_sounds_box.generic.y	= y += 10*VID_SCALEFACTOR;
...
void AddressBook_MenuInit( void )
{
	...
	// jkrige - scale2d
	s_addressbook_menu.x = (viddef.width / 2) - (144*VID_SCALEFACTOR);
	s_addressbook_menu.y = (viddef.height / 2) - (58*VID_SCALEFACTOR);
	...
	for ( i = 0; i < NUM_ADDRESSBOOK_ENTRIES; i++ )
	{
		...
		// jkrige - scale2d
		s_addressbook_fields[i].generic.y		= i * (18*VID_SCALEFACTOR) + 0;
		...
		// jkrige - scale2d
		//s_addressbook_fields[i].length			= 60*VID_SCALEFACTOR;
		//s_addressbook_fields[i].visible_length	= 30*VID_SCALEFACTOR;
...
qboolean executed_texturefilter;
// jkrige - anisotropic filtering
...
qboolean PlayerConfig_MenuInit( void )
{
	...
	// jkrige - scale2d
	s_player_config_menu.x = viddef.width * 0.50 - (95*VID_SCALEFACTOR); 
	s_player_config_menu.y = viddef.height * 0.50 - (97*VID_SCALEFACTOR);
	...
	// jkrige - scale2d
	s_player_name_field.generic.x		= -8*VID_SCALEFACTOR;
	//s_player_name_field.generic.x		= 0;
	// jkrige - scale2d
	s_player_name_field.generic.y		= 0;
	s_player_name_field.length	= 21;
	s_player_name_field.visible_length = 21;
	...
	// jkrige - scale2d
	s_player_model_title.generic.x    = -16*VID_SCALEFACTOR;
	s_player_model_title.generic.y	 = 60*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_player_model_box.generic.x	= -64*VID_SCALEFACTOR;
	s_player_model_box.generic.y	= 70*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_player_skin_title.generic.x    = -24*VID_SCALEFACTOR;
	s_player_skin_title.generic.y	 = 84*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_player_skin_box.generic.x	= -64*VID_SCALEFACTOR;
	s_player_skin_box.generic.y	= 94*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_player_hand_title.generic.x    = 24*VID_SCALEFACTOR;
	s_player_hand_title.generic.y	 = 108*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_player_handedness_box.generic.x	= -64*VID_SCALEFACTOR;
	s_player_handedness_box.generic.y	= 118*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_player_rate_title.generic.x    = 48*VID_SCALEFACTOR;
	s_player_rate_title.generic.y	 = 156*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_player_rate_box.generic.x	= -64*VID_SCALEFACTOR;
	s_player_rate_box.generic.y	= 166*VID_SCALEFACTOR;
	...
	// jkrige - scale2d
	s_player_download_action.generic.x	= -32*VID_SCALEFACTOR;
	s_player_download_action.generic.y	= 186*VID_SCALEFACTOR;
...
void PlayerConfig_MenuDraw( void )
{
	...
	// jkrige - scale2d
	refdef.x = viddef.width * 0.50;
	refdef.y = viddef.height * 0.50 - (71*VID_SCALEFACTOR);
	refdef.width = 144*VID_SCALEFACTOR;
	refdef.height = 171*VID_SCALEFACTOR;
	...
	refdef.fov_x = 40;
	//refdef.fov_y = CalcFov( refdef.fov_x, refdef.width*VID_SCALEFACTOR, refdef.height*VID_SCALEFACTOR );
	...
	if ( s_pmi[s_player_model_box.curvalue].skindisplaynames )
	{
		...
		ent->origin[1] = 0;
		ent->origin[2] = 0;
		VectorCopy( modelOrg, ent->origin ); // jkrige - render weapon model
		...
		// jkrige - scale2d
		M_DrawTextBox( ( refdef.x ) * ( 320.0f / viddef.width ) - 8, ( viddef.height / 2 ) * ( 240.0f / viddef.height) - 77, (refdef.width/VID_SCALEFACTOR) / 8, (refdef.height/VID_SCALEFACTOR) / 8 );
		...
		// jkrige - anisotropic filtering
		if (!executed_texturefilter)
		{
			re.RunTextureMode();
			executed_texturefilter = true;
		}
		// jkrige - anisotropic filtering
		...
		// jkrige - scale2d
		re.DrawPic( s_player_config_menu.x - (48*VID_SCALEFACTOR), refdef.y, scratch );
...
void M_Quit_Draw (void)
{
	...
	// jkrige - scale2d
	re.DrawPic ( (viddef.width-(w*VID_SCALEFACTOR))/2, (viddef.height-(h*VID_SCALEFACTOR))/2, "quit");
