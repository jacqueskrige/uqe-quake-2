...
//	cl_minfps = Cvar_Get ("cl_minfps", "5", 0);
	...
	// jkrige - mouse sensitivity - begin
	//sensitivity = Cvar_Get ("sensitivity", "3", CVAR_ARCHIVE);
	sensitivity = Cvar_Get ("sensitivity", "6", CVAR_ARCHIVE);
	// jkrige - mouse sensitivity - end
...
cheatvar_t	cheatvars[] = {
	...
	{"cl_testlights", "0"},
	{"r_fullbright", "0"},
	{"gl_wireframe", "0"}, // jkrige - wireframe
	{"r_drawflat", "0"},
	{"paused", "0"},
	{"fixedtime", "0"},
	{"sw_draworder", "0"},
