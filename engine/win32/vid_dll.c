...
*/
//extern qboolean s_win95; // jkrige - remove windows version check
...
vidmode_t vid_modes[] =
{
	...
	{ "Mode 0: 320x240",	320,	240,	0 }, // 4  : 3
	{ "Mode 1: 640x480",	640,	480,	1 }, // 4  : 3
	{ "Mode 2: 1024x768",	1024,	768,	2 }, // 4  : 3
	{ "Mode 3: 1280x720",	1280,	720,	3 }, // 16 : 9
	{ "Mode 4: 1366x768",	1366,	768,	4 }, // 16 : 9
	{ "Mode 5: 1600x900",	1600,	900,	5 }, // 16 : 9
	{ "Mode 6: 1440x900",	1440,	900,	6 }, // 16 : 10
	{ "Mode 7: 1680x1050",	1680,	1050,	7 }, // 16 : 10
	{ "Mode 8: 1920x1080",	1920,	1080,	8 }, // 16 : 9
	{ "Mode 9: 3840x2160",	3840,	2160,	9 }, // 16 : 9
	...
	{ "Mode 5: 1280x720",  1280, 720,  5 },
	{ "Mode 6: 1280x960",  1280, 960, 6 },
	{ "Mode 7: 1600x900", 1600, 900, 7 },
	{ "Mode 8: 1600x1200", 1600, 1200, 8 },
...
void VID_CheckChanges (void)
{
	...
	while (vid_ref->modified)
	{
		...
		*/
		...
		{
			// jkrige - video refresh
			//if ( strcmp (vid_ref->string, "soft") == 0 )
			//	Com_Error (ERR_FATAL, "Couldn't fall back to software refresh!");
			//Cvar_Set( "vid_ref", "soft" );
			if ( strcmp (vid_ref->string, "gl") == 0 )
				Com_Error (ERR_FATAL, "Couldn't fall back to opengl refresh!");
			Cvar_Set( "vid_ref", "gl" );
			// jkrige - video refresh
...
void VID_Init (void)
{
	...
	vid_gamma = Cvar_Get("vid_gamma", "2.2", CVAR_ARCHIVE);
	// jkrige - gamma
