...
// jkrige - scale2d
/*
** VID_Scale2D (SCR_Scale2D)
*/
void VID_Scale2D (viddef_t *vdef)
{
	float AspectRatio;
	...
	//vidscale2d->height = (float)viddef.height / vidscale2d->factor;
	//vidscale2d->width = (float)AspectRatio * vidscale2d->height;
...
void GLimp_Shutdown( void )
{
	...
	if (glw_state.hWnd)
	{
		// jkrige - remove left-over taskbar icons
